...
from src.schemas.profiles import ProfileDetailResponseSchema, ProfileFormSchema
...
@router.post("/profiles/", response_model=ProfileDetailResponseSchema)
async def create_current_user_profile(
    ...
    return await UserProfileService.create_user_profile(
        db=db,
